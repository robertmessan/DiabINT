...
st.markdown('<h1 style="color: purple;">Suivez au plus près votre équilibre taux de glucose/taux d'insuline pour voyager en toute tranquilité. Déterminer en tant réel l'influence de votre alimentation sur cette équilibre pour profiter pleinement de votre voyage. Voyagez sans souci, voyagez avec DiabINT!</h1>', unsafe_allow_html=True)
